...
PetscErrorCode Objects_Create(SDDFT_OBJ* pSddft)
{
  ...
  { 
    ...
    {
	    DMDACreate3d(
        PETSC_COMM_SELF, DM_BOUNDARY_GHOSTED, DM_BOUNDARY_GHOSTED, DM_BOUNDARY_GHOSTED,
  ...
  { 
    ...
    {
      DMDACreate3d(
        PETSC_COMM_SELF, DM_BOUNDARY_PERIODIC, DM_BOUNDARY_PERIODIC, DM_BOUNDARY_PERIODIC,
        DMDA_STENCIL_STAR, n_x, n_y, n_z,
		    PETSC_DECIDE, PETSC_DECIDE, PETSC_DECIDE, 1, o, 0, 0, 0, &pSddft->da
      );
	    DMDACreate3d(
      ...
      DMDACreate3d(
        PETSC_COMM_WORLD, DM_BOUNDARY_PERIODIC, DM_BOUNDARY_PERIODIC, DM_BOUNDARY_PERIODIC,
        DMDA_STENCIL_STAR, n_x, n_y, n_z,
        PETSC_DECIDE, PETSC_DECIDE, PETSC_DECIDE, 1, o, 0, 0, 0, &pSddft->da
      );
	    DMDACreate3d(
...
PetscErrorCode Gradient_matInit(SDDFT_OBJ* pSddft)
{
  ...
  PetscInt i,j,k,l,colidx,gxdim,gydim,gzdim,xcor,ycor,zcor,lxdim,lydim,lzdim;PetscInt qq;
  MatStencil row;
  MatStencil* col_x;
  MatStencil* col_y;
  MatStencil* col_z;
