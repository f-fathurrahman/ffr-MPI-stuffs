...
{    
  ...
  PetscInt  i=0,j,k,xi,yj,zk,offset,I,J,K,p,nzVps,nyVps,nxVps,
...
void ChargDensB_TM_VecInit(SDDFT_OBJ* pSddft)
{
  ...
  PetscScalar pVpsArray_TM_KJI, pVpsArray_TM_KJIma, pVpsArray_TM_KJIpa, pVpsArray_TM_KJmaI, pVpsArray_TM_KJpaI, pVpsArray_TM_KmaJI, pVpsArray_TM_KpaJI;
  int at;
  PetscInt  i=0,j,k,xi,yj,zk,offset,tablesize,l,I,J,K,p,nzVps,nyVps,nxVps,i0,j0,k0,a,poscnt,index=0;
