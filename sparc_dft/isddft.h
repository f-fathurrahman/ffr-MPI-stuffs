...
typedef struct
{
  ...
  ///< For each type of atom, noa stores the number of atoms of that type,
  ///< noe stores the number of valence electrons of that type
  PetscInt *noa, *noe;
  ...
  /// stores the shift for correction electrostatic potential under periodic boundary conditions
  PetscScalar ConstShift;
  ...
  ///< stores the number of times Chebychev filtering is done in the first SCF
  ///< iteration before updation of electron density
  PetscInt SCFNewRhoCalcCtr; 
  
  ///< stores the number of relaxation steps done. This is incremented for every relaxation step.
  int RelaxCount;
  ...
  Mat *XOrb1; ///< Real part of input to chebyshev filter orbitals for k-point code
  Mat *XOrb2; ///< Imaginary part of input to chebyshev filter orbitals for k-point code
  Mat *YOrb1; ///< Real part of chebyshev filtered orbitals for k-point code
  Mat *YOrb2; ///< Imaginary part of chebyshev filtered orbitals for k-point code
  Mat YOrbNew1; ///< Stores a temporary copy of the real part of orbitals in chebyshev filtering
  Mat YOrbNew2; ///< Stores a temporary copy of the imaginary part of orbitals in chebyshev filtering
  Mat ZOrb1; ///< Stores a temporary copy of the real part of orbitals in chebyshev filtering
  Mat ZOrb2;  ///< Stores a temporary copy of the imaginary part of orbitals in chebyshev filtering
  Mat ZOrbNew1; ///< Stores a temporary copy of the real part of orbitals in chebyshev filtering
  Mat ZOrbNew2; ///< Stores a temporary copy of the imaginary part of orbitals in chebyshev filtering
  Mat HamiltonianOpr1; ///< PETSc distributed sparse matrix (row major format) for storing the real part of k-point Hamiltonian 
  Mat HamiltonianOpr2; ///< PETSc distributed sparse matrix (row major format) for storing the imaginary part of k-point Hamiltonian  
